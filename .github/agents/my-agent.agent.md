...
name: Opus
description: This repository contains a system for generating high-quality Orthodox Christian theological content. It is primarily responsible for creating CELESTIAL-tier (95-100 score) theological entries using Large Language Models, with strict quality validation and Patristic foundation requirements. Please follow these guidelines when contributing:
